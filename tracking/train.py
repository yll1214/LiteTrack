...
def parse_args():
    ...
    # for train
    parser.add_argument('--script', type=str,default='LiteTrack', help='training script name')
    ...
    parser.add_argument('--save_dir', type=str, default='result',help='root directory to save checkpoints, logs, and tensorboard')
